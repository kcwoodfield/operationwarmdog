    ...
    <main>
      ...
      <div className={styles.info}>
        ...
        <section>
          ...
          <p>If you are a coworker, friend or neighbor and can't get to Park Terrace, no worries we'll come get your items OR you can drop them off at the office and we'll come get them.  <br/><br/>Ping me for more details. Will try to reply asap: <Link href="mailto:kevin@operationwarmdog.org">kevin@operationwarmdog.org</Link></p>
        </section>
